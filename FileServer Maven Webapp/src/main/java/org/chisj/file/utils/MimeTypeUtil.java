...
public class MimeTypeUtil {
	 ...
	 * 图片
	 */
	public static final SourceType pic = new SourceType("1", "图片", "upload/pic");
	
	/**
	 * 音频
	 */
	public static final SourceType audio = new SourceType("2", "音频", "upload/audio");
	
	/**
	 * 视频
	 */
	public static final SourceType video = new SourceType("3", "视频", "upload/video");
	
	/**
	 * 文档
	 */
	public static final SourceType doc = new SourceType("4", "文档", "upload/doc");
	
	/**
	 * 可执行程序
	 */
	public static final SourceType exe = new SourceType("5", "可执行程序", "upload/exe");
	...
	public static String getFilePath(Resource resource) {
		...
		int index = resource.getPath().indexOf(type);
		//System.out.println("index = " + index);
		return resource.getPath().substring(index);
